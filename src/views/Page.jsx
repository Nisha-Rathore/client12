...
import { Dumbbell, Users, Calendar, ShoppingBag, Mail, Phone, MapPin, Home } from 'lucide-react';
...
const Page = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-teal-50 via-teal-100 to-teal-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex space-x-2">
              <Link to="/signIn" className="bg-gradient-to-r from-teal-500 to-teal-500 text-white px-4 py-2 rounded-lg font-semibold hover:from-teal-600 hover:to-teal-600 shadow">
                Login
              </Link>
      ...
      <section id="home" className="pt-20 min-h-[80vh] flex items-center justify-center bg-gradient-to-r from-teal-300 via-teal-400 to-teal-400 text-white relative">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-10">
          ...
          <div className="space-x-4">
            <Link to="/signIn" className="bg-white text-teal-700 px-8 py-3 rounded-lg font-bold shadow-lg hover:bg-teal-100 transition">
              Get Started Free
      ...
      {/* Features Section */}
      <section id="services" className="py-20 bg-gradient-to-br from-teal-50 via-teal-50 to-teal-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-md hover:shadow-lg border-t-4 border-teal-400 transition-all">
              <ShoppingBag className="h-12 w-12 text-teal-500 mb-4" />
      ...
      {/* Why Us Section */}
      <section id="whyus" className="py-20 bg-gradient-to-r from-teal-100 via-teal-100 to-teal-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <section id="about" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-gradient-to-br from-teal-50 to-teal-100 p-8 rounded-2xl shadow-md">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div className="bg-white p-6 rounded-2xl shadow border-t-4 border-teal-200">
              <form className="space-y-4">
                ...
                <button type="submit" className="w-full bg-gradient-to-r from-teal-500 to-teal-500 text-white py-2 px-4 rounded-lg shadow hover:from-teal-600 hover:to-teal-600 font-bold transition">
                  Send Message
                </button>
              </form>
            </div>
      ...
      {/* Footer */}
      <footer className="bg-gradient-to-br from-teal-800 via-teal-900 to-teal-800 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
